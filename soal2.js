...
let dataLog = `03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
fs.writeFile("log.txt", dataLog, (err) => {
  if (err) console.log(err);
  console.log("File has been written in log.txt");
});
